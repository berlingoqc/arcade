...
@customElement('arc-crystal-cave-background')
export class CrystalCaveElement extends LitElement {
    ...
    render() {
        return html`<canvas id="game-wrapper"></canvas>`;
    }
    ...
    firstUpdated() {
        ...
        function state() {
            ...
            console.log('INITIITITITITI');
            // let's create an instance of our class Application

            let wrapper = shadowThis.shadowRoot.querySelector('#game-wrapper');
            const app = new Application(wrapper);
            // Add our UI
            // update light position
            wrapper.addEventListener('mousemove', function (e: any) {
...
class Application {
    ...
    universe: any;
    center: any;
    constructor(public wrapper: Element) {
    ...
    resize() {
        ...
        (this.wrapper as any).style.width = this.width + 'px';
        (this.wrapper as any).style.height = this.height + 'px';
